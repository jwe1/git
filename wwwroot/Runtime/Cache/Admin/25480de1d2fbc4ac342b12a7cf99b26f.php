...
<body>
	...
	<div class="cf">
		<div class="fl">
			...
			<button class="btn ajax-post confirm" target-form="ids" url="<?php echo U("Activities/setStatus",array("status"=>-1));?>">删 除</button>
		...
		<table>
            ...
            <tbody>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><!--  <tr>
						...
						<?php if(is_array($list_grids)): $i = 0; $__LIST__ = $list_grids;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$grid): $mod = ($i % 2 );++$i;?><td>1<?php echo get_list_field($data,$grid);?></td><?php endforeach; endif; else: echo "" ;endif; ?>
					...
					<tr>
						...
						<td><?php echo date('Y-m-d ',$data['deadline'])?></td>
						<td><?php echo date('Y-m-d',$data['create_time'])?></td>
						<td><?php
 if($data['status']==0){ echo '未审核'; }elseif($data['status']==1){ echo '成功'; }else{ echo '失败'; }?>
						</td>
						<td>
							<?php if($data['status'] != 0){ echo '已审核'; }else{ echo '<a  id="success"  href="javascript:;">审核通过</a>&nbsp&nbsp&nbsp'; echo '<a  id="fail" href="javascript:;">审核不通过</a>'; } ?>
						</td>
...
/*	//点击修改状态*/
var url ="<?php echo U('Activities/status','','');?>";
