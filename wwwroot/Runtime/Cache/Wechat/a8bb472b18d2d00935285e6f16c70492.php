...
<div class="main" >
    ...
    <nav class="navbar navbar-default navbar-fixed-bottom" >
        <div class="container-fluid text-center">
            <div class="col-xs-3">
                <p class="navbar-text"><a href="<?php echo U('Index/index');?>" class="navbar-link">首</a></p>
            </div><div class="col-xs-3">
            <p class="navbar-text"><a href="<?php echo U('Index/service');?>" class="navbar-link">服务</a></p>
        </div><div class="col-xs-3">
            <p class="navbar-text"><a href="<?php echo U('Index/zushou');?>" class="navbar-link">发现</a></p>
        </div><div class="col-xs-3">
    ...
    <div class="container" style="width:400px;margin:0 auto">
        ...
        <form  action="/wechat.php/Wechat/Login/login.html" method="post">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <img class="verifyimg reloadverify" alt="点击切换" src="<?php echo U('Wechat/Login/verify',array());?>" onclick="this.src='<?php echo U('Wechat/Login/verify',array());?>'" style="cursor:pointer;">
                </div>
        ...
        <p class="text-danger text-right"><a href="http://www.ot.com/index.php?s=/Home/Login/register.html">新用户注册</a></p>
    </div>
    <!-- /container -->
