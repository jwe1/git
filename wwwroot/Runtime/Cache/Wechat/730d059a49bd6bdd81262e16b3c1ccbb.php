...
<div class="main">
    ...
    <div class="container-fluid">
        <?php if(!empty($lists)): if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><div class="row noticeList">
                    <div class="col-xs-2">
                        <a href="<?php echo U('my_detail',['id'=>$list['id']]);?>">
                        <img class="noticeImg" src="<?=$list['path']?>" style="width:180px"/></a>
                    </div>
                    <div class="col-xs-10">

                        <p class="title"><a href="<?php echo U('notice_detail',['id'=>$art['id']]);?>" > <?=$art['title']?></a></p>
