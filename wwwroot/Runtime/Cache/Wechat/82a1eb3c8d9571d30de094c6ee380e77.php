        ...
        <div class="bs-example bs-example-tabs" data-example-id="togglable-tabs">
            ...
            <div id="myTabContent" class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                    ...
                    <div class="row">
                     <!--   出租-->
                        <?php if(!empty($zu)): foreach($zu as $z):?>
                                    <div class="col-xs-6 col-md-4">
                                        <div class="thumbnail">
                                            <a href="<?php echo U('zushou_detail',['id'=>$z['id']]);?>">
                                                <img src="<?=$z['path']?>" alt="..."></a>
                                            <div class="caption">
                                                <h4><?=$z['title']?></h4>
                                                <p class="zushouInfo"><?=$z['description']?></p>
                                                <p class="text-danger"><?=$z['price']?><?=$z['danwei']?'元/月':'万/月'?></p>
                                                <p><a href="<?php echo U('zushou_detail',['id'=>$z['id']]);?>" class="btn btn-danger zushouBtn">详细信息</a> </p>
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach;?>
                ...
                <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
                    <div class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                        ...
                        <div class="row">
                            <?php if(!empty($shou)): foreach($shou as $s):?>
                                    <div class="col-xs-6 col-md-4">
                                        <div class="thumbnail">
                                            <a href="<?php echo U('zushou_detail',['id'=>$s['id']]);?>">
                                                <img src="<?=$s['path']?>" alt="..."></a>
                                            <div class="caption">
                                                <h4><?=$s['title']?></h4>
                                                <p class="zushouInfo"><?=$s['description']?></p>
                                                <p class="text-danger"><?=$s['price']?><?=$s['danwei']?'元/月':'万/月'?></p>
                                                <p><a href="<?php echo U('zushou_detail',['id'=>$s['id']]);?>" class="btn btn-danger zushouBtn">详细信息</a> </p>
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach;?>
