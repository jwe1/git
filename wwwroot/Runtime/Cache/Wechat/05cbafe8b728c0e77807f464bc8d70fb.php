...
<div class="main">
    ...
    <div class="container-fluid">
        ...
        <div class="noticeDetailInfo">发布者:<?=$list['name']?></div>
        <div class="noticeDetailInfo">发布时间：<?=date('Y-m-d',$list['create_time'])?></div>
        <div><a href="javascript:;" class="join" data-id="<?=$list['id']?>">参加活动</a></div>
