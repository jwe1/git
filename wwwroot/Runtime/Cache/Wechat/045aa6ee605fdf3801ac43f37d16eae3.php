...
<div class="main">
    ...
    <div class="container-fluid">
        <div class="blank"></div>
        <h3 class="noticeDetailTitle"><strong><?=$sale['title']?></strong></h3>
        <div class="noticeDetailInfo">发布人：<?=$sale['username']?></div>
        <div class="noticeDetailInfo">发布时间：<?=date('Y-m-d',$sale['title'])?></div>
        <div class="noticeDetailInfo">联系电话：<?=$sale['tel']?></div>
        <h4 class="text-danger">价格:<?=$sale['price']?><?=$sale['type']?'元/月':'万/月'?></h4>
